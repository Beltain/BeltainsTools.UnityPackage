...
* Added a Singleton class for easy singleton setup
* Added AssetRegisterObject system to allow for lookup of loaded asset references
* Added FlagGate logic class for easy blocking/whitelisting of features
* Added DampedSprings maths and related JUICE components (SpringyTransform, Wiggler, SpringyTargetFollower, etc)
